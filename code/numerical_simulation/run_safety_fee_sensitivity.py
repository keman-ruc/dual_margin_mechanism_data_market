...
from sim_runner import run_single_simulation, run_single_simulation_with_safety_fee
...
def run_one_replication(
    ...
    for multiple in fee_grid:
        safety_fee_vector = float(multiple) * d_min_vector
        result = run_single_simulation_with_safety_fee(
            cfg,
            params,
            seed_share_f=seed_share,
            beta=beta_star,
            ...
            initial_state=shared_initial_state,
            update_schedule=shared_update_schedule,
            safety_fee_multiple=float(multiple),
...
def main() -> None:
    ...
    cfg.safety_fee_multipliers = tuple(fee_grid)
